"""Gauss-Legendre Quadrature routine copied from quicklens, it is
originally written by kendrick smith. Another good implementation is
in Toshiya's cmblensplus. I think Toshiya's version is faster because
it doesn't do repeative calculations. I will switch to that version if
